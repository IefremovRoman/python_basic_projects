...
def game_simulator(items=25, init_bet=1, detailed_output=True):
  ...
  def betting():
    ...
    while True and MONEY:
      ...
      if bet_answer == 'y' and MONEY:
        ...
        bet_item, bet_value = choice(field_types + list(range(37))), init_bet
...
game_simulator(items, init_bet, detailed_output)
